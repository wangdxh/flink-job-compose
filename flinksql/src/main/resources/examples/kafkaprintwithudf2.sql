...
create  function MyStringFunction2 as 'com.kedacom.flinksqlfunction2.UdfFunction';
...
insert into print_table select i32, MyStringFunction2(enums) from kafkaprotobuf;
