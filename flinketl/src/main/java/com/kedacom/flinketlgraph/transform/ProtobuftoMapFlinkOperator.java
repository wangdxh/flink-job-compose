...
public class ProtobuftoMapFlinkOperator extends AbstractFlinkOperator
{
    private ElementDescriptor desc = CommonUtils.createElementDesc(
            "flinktransform_protobuftomap",
            "protobuftomap transform",
            CommonUtils.Transform,
            CommonUtils.readfile("jsonfilesgraph/protobufjsonnodespec.json"),
            Arrays.asList(
