...
public class CsvtomapFlinkOperator extends AbstractFlinkOperator
{
    private ElementDescriptor desc = CommonUtils.createElementDesc(
            "flinktransform_csvtomap",
            "cvstomap transform",
            CommonUtils.Transform,
            CommonUtils.readfile("jsonfilesgraph/csvtomapspec.json"),
            Arrays.asList(
    ...
    {
        return trans.flatMap(new CsvtomapFlatMap(transconfig)).returns(Types.GENERIC(Object.class));
    }
}
